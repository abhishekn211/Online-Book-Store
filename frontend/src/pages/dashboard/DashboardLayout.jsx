        ...
        <div className="flex flex-shrink-0 items-center ml-auto">
          <button className="inline-flex items-center p-2 hover:bg-gray-100 focus:bg-gray-100 rounded-lg">
            ...
            <div className="hidden md:flex md:flex-col md:items-end md:leading-tight">
              <span className="font-semibold">Abhishek Nigam</span>
              <span className="text-sm text-gray-600">SDE-II</span>
            </div>
            <span className="h-12 w-12 ml-2 sm:ml-3 mr-2 bg-gray-100 rounded-full overflow-hidden">
              <img src="https://img.freepik.com/free-vector/hand-drawn-pumpkin-cartoon-illustration_23-2150622701.jpg?semt=ais_incoming" alt="user profile photo" className="h-full w-full object-cover"/>
            </span>
